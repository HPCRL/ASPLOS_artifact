...
void ukr_full_trace(float* A, float*B, float*C, long long ctile, long long * Astrides){
    const int rxy =3;
    const int rf = 24;
...
void ukr_part_img_trace(float* A, float*B, float*C, long long ctile, long long * Astrides){
