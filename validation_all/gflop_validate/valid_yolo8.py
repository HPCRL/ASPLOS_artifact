...
def run_instance(Txy, Tf, Tc):
    ...
    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=256 -DuNx=34 -DuNy=34 -DuNc=512 -DuNw=1 -DuNh=1 -DEdgeXY=4 -DuSx=1 -DuSy=1 testbed.cpp'
