...
def run_instance(Txy, Tf, Tc):
    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=64 -DuNx=112 -DuNy=112 -DuNc=3 -DuNw=7 -DuNh=7 -DEdgeXY=4 -DuSx=2 -DuSy=2 testbed.cpp'
    cmd += ' -DTxy3=' + str(Txy) 
    cmd += ' -DTf2=' + str(Tf)
    cmd += ' -DTc1=' + str(Tc)
