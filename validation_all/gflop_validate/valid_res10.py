...
#    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=512 -DuNx=7 -DuNy=7 -DuNc=512 -DuNw=3 -DuNh=3 -DEdgeXY=1 -DuSx=2 -DuSy=2 testbed.cpp'
    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=512 -DuNx=7 -DuNy=7 -DuNc=256 -DuNw=3 -DuNh=3 -DEdgeXY=1 -DuSx=2 -DuSy=2 testbed.cpp '
    cmd += ' -DTxy3=' + str(Txy) 
    cmd += ' -DTf2=' + str(Tf)
    cmd += ' -DTc1=' + str(Tc)
