...
def run_instance(Txy, Tf, Tc):
    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=28272 -DuNx=17 -DuNy=17 -DuNc=1024 -DuNw=1 -DuNh=1 -DEdgeXY=1 -DuSx=1 -DuSy=1 testbed.cpp'
