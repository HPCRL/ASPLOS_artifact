...
def run_instance(Txy, Tf, Tc):
    ...
    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=128 -DuNx=224 -DuNy=112 -DuNc=64 -DuNw=3 -DuNh=3 -DEdgeXY=2 -DuSx=1 -DuSy=1 testbed.cpp'
...
def gen_pred(Nxy, Nf, Nc, Txy, Tf, Tc, cache_size, bandwidth):
    ...
    #L3,  Txy, Tf, Tc, -> Txy
    Input.append( (1+2)*(Nxy+2)*Tc*  (Nxy/Nxy*Nf/Tf*Nc/Tc))
    Kernel.append( Tf*3*3*Tc*  (Nxy/Nxy*Nf/Tf*Nc/Tc))
    Output.append( Nxy*Tf*  (Nxy/Nxy*Nf/Tf*Nc/Tc))
