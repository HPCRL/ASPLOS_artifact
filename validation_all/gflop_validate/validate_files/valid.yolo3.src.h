...
#include "omp.h"
#include "transpose.h"
#include "gen_ukr_A6B2gemm_1_128_136_136_64_3_3.h"
#include "gen_ukr_A4B2gemm_1_128_136_136_64_3_3.h"
...
int offsetA=0+b1*1218816+c1_1*19044+1*x1*138+1*y1*1+c1_2*1;
int offsetB=0+kf1_1*9216+c1*144+0*48+0*16+kf1_2*1;
int offsetC=0+b1*2367488+of1_1*18496+x1*136+y1*1+of1_2*1;
