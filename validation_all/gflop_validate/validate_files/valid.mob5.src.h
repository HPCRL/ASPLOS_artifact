...
#include "omp.h"
#include "transpose.h"
#include "gen_ukr_A6B2gemm_1_256_28_28_256_3_3.h"
#include "gen_ukr_A4B2gemm_1_256_28_28_256_3_3.h"
...
int offsetA=0+b1*230400+c1_1*900+1*x1*30+1*y1*1+c1_2*1;
int offsetB=0+kf1_1*36864+c1*144+0*48+0*16+kf1_2*1;
int offsetC=0+b1*200704+of1_1*784+x1*28+y1*1+of1_2*1;
