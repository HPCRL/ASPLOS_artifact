...
#    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=256 -DuNx=7 -DuNy=7 -DuNc=512 -DuNw=1 -DuNh=1 -DEdgeXY=1 -DuSx=2 -DuSy=2 testbed_likwid.cpp -DLIKWID_PERFMON -Wl,-rpath=/opt/local/lib -llikwid'

    cmd = 'icpc -O3 -Ofast -march=native -fopenmp -I../Vary_Layout_UKR/build -DLKF=16 -DLC=1 -DLOF=1 -DuNf=512 -DuNx=7 -DuNy=7 -DuNc=256 -DuNw=1 -DuNh=1 -DEdgeXY=1 -DuSx=2 -DuSy=2 testbed_likwid.cpp -DLIKWID_PERFMON -Wl,-rpath=/opt/local/lib -llikwid '
...
def gen_pred(Nxy, Nf, Nc, Txy, Tf, Tc, cache_size, bandwidth):
    ...
    if (2*Tyy)*(2*Txx)*Tc + Tf*1*1*Tc + Txy*Tf:
        Txx=Tyy=7
        Txy=Nxy
    #L3,  Txy, Tf, Tc, -> Nf
