...
do
    ...
    yrange=${arr[3]}
    ukrrow=$((yrange<10 ? yrange : 10))
    echo ${arr[0]} ${arr[1]} ${arr[2]} ${arr[3]} ${arr[4]} ${arr[5]} ${arr[6]} 16 1 1 $Nthread $ukrrow 32 ${arr[7]} ${arr[8]}
    
    python main.py ${arr[0]} ${arr[1]} ${arr[2]} ${arr[3]} ${arr[4]} ${arr[5]} ${arr[6]} 16 1 1 $Nthread $ukrrow 32 ${arr[7]} ${arr[8]} > "$1.dirK1611/layer$cnt.cxy16-1-1_threads$OMP_NUM_THREADS.cnn$line.out"
