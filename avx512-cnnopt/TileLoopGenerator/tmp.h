...
{
for(int c3=c4;c3<min(512, 512+c4);c3+=512)
{
for(int xy3=xy4;xy3<min(289, 289+xy4);xy3+=30)
{    
for(int xy2=xy3;xy2<min(289, 30+xy3);xy2+=10)
{
for(int f2=f3;f2<min(1024, 32+f3);f2+=32)
{
for(int c2=c3;c2<min(512, 512+c3);c2+=128)
{
