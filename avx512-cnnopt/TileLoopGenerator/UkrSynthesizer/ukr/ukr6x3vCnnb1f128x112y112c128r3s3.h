#pragma once
#include "immintrin.h"
void ukr6x3vCnnb1f128x112y112c128r3s3(float* A,float* B,float* C,int* Astrd)
{
__m512 Amm0;
__m512 Amm1;
__m512 Amm2;
...
Cmm5_2 = _mm512_fmadd_ps(Amm1, Bmm2, Cmm5_2);
