#pragma once
#include "immintrin.h"
void ukr8x2vCnnb1f64x112y112c32r3s3(float* A,float* B,float* C,int* Astrd)
{
__m512 Amm0;
__m512 Amm1;
__m512 Amm2;
...
Cmm6_0 = _mm512_load_ps(C+192+0);
Cmm6_1 = _mm512_load_ps(C+192+16);
Cmm7_0 = _mm512_load_ps(C+224+0);
Cmm7_1 = _mm512_load_ps(C+224+16);
...
_mm512_store_ps(C+192+0, Cmm6_0);
_mm512_store_ps(C+192+16, Cmm6_1);
_mm512_store_ps(C+224+0, Cmm7_0);
_mm512_store_ps(C+224+16, Cmm7_1);
}
