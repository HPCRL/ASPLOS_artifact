#pragma once
#include "immintrin.h"
void ukr7x3vCnnb1f128x112y112c128r3s3(float* A,float* B,float* C,int* Astrd)
{
__m512 Amm0;
__m512 Amm1;
__m512 Amm2;
...
Cmm5_2 = _mm512_fmadd_ps(Amm0, Bmm2, Cmm5_2);
Cmm6_0 = _mm512_fmadd_ps(Amm1, Bmm0, Cmm6_0);
Cmm6_1 = _mm512_fmadd_ps(Amm1, Bmm1, Cmm6_1);
Cmm6_2 = _mm512_fmadd_ps(Amm1, Bmm2, Cmm6_2);
...
T6 = _mm512_unpacklo_ps(Cmm6_0, ZeroMM);
T7 = _mm512_unpackhi_ps(Cmm6_0, ZeroMM);
...
T6 = _mm512_unpacklo_ps(Cmm6_1, ZeroMM);
T7 = _mm512_unpackhi_ps(Cmm6_1, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
...
T6 = _mm512_unpacklo_ps(Cmm6_2, ZeroMM);
T7 = _mm512_unpackhi_ps(Cmm6_2, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
