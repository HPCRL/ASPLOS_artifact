#pragma once
#include "immintrin.h"
void ukr9x3vCnnb1f128x112y112c128r3s3(float* A,float* B,float* C,int* Astrd)
{
__m512 Amm0;
__m512 Amm1;
__m512 Amm2;
...
Cmm8_1 = _mm512_fmadd_ps(Amm0, Bmm1, Cmm8_1);
Cmm8_2 = _mm512_fmadd_ps(Amm0, Bmm2, Cmm8_2);
// c2iter=0, riter=0,siter=2
Amm1 = _mm512_set1_ps(A[8+2]);
...
Cmm8_0 = _mm512_fmadd_ps(Amm1, Bmm0, Cmm8_0);
Cmm8_1 = _mm512_fmadd_ps(Amm1, Bmm1, Cmm8_1);
Cmm8_2 = _mm512_fmadd_ps(Amm1, Bmm2, Cmm8_2);
...
T8 = _mm512_unpacklo_ps(Cmm8_0, ZeroMM);
T9 = _mm512_unpackhi_ps(Cmm8_0, ZeroMM);
...
T8 = _mm512_unpacklo_ps(Cmm8_1, ZeroMM);
T9 = _mm512_unpackhi_ps(Cmm8_1, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
...
T8 = _mm512_unpacklo_ps(Cmm8_2, ZeroMM);
T9 = _mm512_unpackhi_ps(Cmm8_2, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
