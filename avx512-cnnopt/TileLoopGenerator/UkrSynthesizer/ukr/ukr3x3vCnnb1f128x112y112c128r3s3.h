#pragma once
#include "immintrin.h"
void ukr3x3vCnnb1f128x112y112c128r3s3(float* A,float* B,float* C,int* Astrd)
{
__m512 Amm0;
__m512 Amm1;
__m512 Amm2;
...
Cmm2_1 = _mm512_fmadd_ps(Amm0, Bmm1, Cmm2_1);
Cmm2_2 = _mm512_fmadd_ps(Amm0, Bmm2, Cmm2_2);
...
Cmm2_1 = _mm512_fmadd_ps(Amm1, Bmm1, Cmm2_1);
Cmm2_2 = _mm512_fmadd_ps(Amm1, Bmm2, Cmm2_2);
...
T2 = _mm512_unpacklo_ps(Cmm2_0, ZeroMM);
T3 = _mm512_unpackhi_ps(Cmm2_0, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
T0 = _mm512_shuffle_f32x4(R0, ZeroMM, 0x88);
T4 = _mm512_shuffle_f32x4(R0, ZeroMM, 0xdd);
T1 = _mm512_shuffle_f32x4(R1, ZeroMM, 0x88);
T5 = _mm512_shuffle_f32x4(R1, ZeroMM, 0xdd);
T2 = _mm512_shuffle_f32x4(R2, ZeroMM, 0x88);
T6 = _mm512_shuffle_f32x4(R2, ZeroMM, 0xdd);
T3 = _mm512_shuffle_f32x4(R3, ZeroMM, 0x88);
T7 = _mm512_shuffle_f32x4(R3, ZeroMM, 0xdd);
...
T2 = _mm512_unpacklo_ps(Cmm2_1, ZeroMM);
T3 = _mm512_unpackhi_ps(Cmm2_1, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
...
T2 = _mm512_unpacklo_ps(Cmm2_2, ZeroMM);
T3 = _mm512_unpackhi_ps(Cmm2_2, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
