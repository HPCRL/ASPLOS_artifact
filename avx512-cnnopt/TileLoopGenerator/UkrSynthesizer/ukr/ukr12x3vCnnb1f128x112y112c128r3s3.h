#pragma once
#include "immintrin.h"
void ukr12x3vCnnb1f128x112y112c128r3s3(float* A,float* B,float* C,int* Astrd)
{
__m512 Amm0;
__m512 Amm1;
__m512 Amm2;
...
Cmm11_0 = _mm512_fmadd_ps(Amm1, Bmm0, Cmm11_0);
Cmm11_1 = _mm512_fmadd_ps(Amm1, Bmm1, Cmm11_1);
Cmm11_2 = _mm512_fmadd_ps(Amm1, Bmm2, Cmm11_2);
