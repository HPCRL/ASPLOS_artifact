#pragma once
#include "immintrin.h"
void ukr13x3vCnnb1f128x112y112c128r3s3(float* A,float* B,float* C,int* Astrd)
{
__m512 Amm0;
__m512 Amm1;
__m512 Amm2;
...
Cmm12_2 = _mm512_fmadd_ps(Amm0, Bmm2, Cmm12_2);
// c2iter=0, riter=0,siter=2
Amm1 = _mm512_set1_ps(A[12+2]);
...
Cmm11_0 = _mm512_fmadd_ps(Amm0, Bmm0, Cmm11_0);
Cmm11_1 = _mm512_fmadd_ps(Amm0, Bmm1, Cmm11_1);
Cmm11_2 = _mm512_fmadd_ps(Amm0, Bmm2, Cmm11_2);
Cmm12_0 = _mm512_fmadd_ps(Amm1, Bmm0, Cmm12_0);
Cmm12_1 = _mm512_fmadd_ps(Amm1, Bmm1, Cmm12_1);
Cmm12_2 = _mm512_fmadd_ps(Amm1, Bmm2, Cmm12_2);
...
T12 = _mm512_unpacklo_ps(Cmm12_0, ZeroMM);
T13 = _mm512_unpackhi_ps(Cmm12_0, ZeroMM);
...
T12 = _mm512_unpacklo_ps(Cmm12_1, ZeroMM);
T13 = _mm512_unpackhi_ps(Cmm12_1, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
...
T12 = _mm512_unpacklo_ps(Cmm12_2, ZeroMM);
T13 = _mm512_unpackhi_ps(Cmm12_2, ZeroMM);
R0 = _mm512_unpacklo_pd(T0, T2);
R1 = _mm512_unpackhi_pd(T0, T2);
R2 = _mm512_unpacklo_pd(T1, T3);
R3 = _mm512_unpackhi_pd(T1, T3);
