...
class ModfileBuilder:
    def __init__(self, sympool, idx_list, level_list, bw_list, parallel_list, parallelism, pbsize_dict, capacity_list, fplist, costlist, parallel_ids, numAB):
    ...
    def buildParallelCons(self):
        ...
        if 'f' in self.parallel_ids:
            ...
            maxf_fork = math.ceil(pbsz_f/self.numAB[-1])
...
class ModGen:
    ...
    def create_modfile(self, nest_tuple, cost_list, target_lv, effective_lv):
        ...
        modfile_builder = ModfileBuilder(self.pool, idx_list=self.idx_list,
                                         ...
                                         costlist=cost_expr_list, fplist=self.level_fp_list,numAB=self.numAB)
