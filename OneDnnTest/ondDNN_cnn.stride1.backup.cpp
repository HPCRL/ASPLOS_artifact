...
void test_conv(engine::kind engine_kind, long long nb, long long nw, long long ns, long long nx, long long ny, long long nf, long long nc){
...
int main(int argc, char**argv){
	...
	std::cout<<"hello\n";
	test_conv(engine_kind, nb, nw, nh, nx, ny, nf, nc);
        std::cout<<" conv pass\n";        
    }catch(dnnl::error &e){
